...
trait Matchable {
  ...
  /**
    ...
    * UCS desugarer.
    */
  private[ucs] def getOrCreateScrutinee(implicit context: Context): ScrutineeData =
  ...
  def getScrutinee(implicit context: Context): Opt[ScrutineeData] = scrutinees.get(context)
