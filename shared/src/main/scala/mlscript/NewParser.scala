            ...
            foundErr || !success pipe { implicit fe =>
              ...
              yeetSpaces match {
                case (KEYWORD("="), _) :: _ =>
                  ...
                  R(NuFunDef(isLetRec, v, tparams, L(ps.foldRight(annotatedBody)((i, acc) => Lam(i, acc))))(isDecl, isExported, N, N))
                case c =>
                  asc match {
                    case S(ty) =>
                    ...
                    case N =>
                      ...
                      consume
                      R(NuFunDef(isLetRec, v, Nil, L(ps.foldRight(errExpr: Term)((i, acc) => Lam(i, acc))))(isDecl, isExported, N, N))
                  }
              }
            }
          case _ =>
