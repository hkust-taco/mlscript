  ...
  private def liftFunc(func: NuFunDef)(using ctx: LocalContext, cache: ClassCache, outer: Option[ClassInfoCache]): (NuFunDef, LocalContext) = {
    ...
    body match {
      case Left(value) =>
        ...
        (func.copy(rhs = Left(ret._1))(func.declareLoc, func.exportLoc, func.signature, func.outer), ret._2)
      case Right(PolyType(targs, body)) =>
        ...
        (func.copy(rhs = Right(PolyType(nTargs._1, nBody._1)))(func.declareLoc, func.exportLoc, func.signature, func.outer),
