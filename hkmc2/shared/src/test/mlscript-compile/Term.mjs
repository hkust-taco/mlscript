...
const Term$class = class Term {
  constructor() {
    ...
    this.SymbolCons.class = class SymbolCons {
      ...
      toString() { return "SymbolCons(" + this.symbol + ")"; }
    };
    ...
    this.TupleCapacity.class = class TupleCapacity {
      ...
      toString() { return "TupleCapacity(" + this.size + ", " + this.inf + ")"; }
    };
    ...
    this.Instantiation.class = class Instantiation {
      ...
      toString() { return "Instantiation(" + this.symbol + ", " + this.args + ")"; }
    };
    ...
    this.LocalPattern.class = class LocalPattern {
      ...
      toString() { return "LocalPattern(" + this.id + ")"; }
    };
    ...
    this.Parameter.class = class Parameter {
      ...
      toString() { return "Parameter(" + this.symbol + ")"; }
    };
    ...
    this.Nested.class = class Nested {
      ...
      toString() { return "Nested(" + this.split + ")"; }
    };
    ...
    this.LiteralStub.class = class LiteralStub {
      ...
      toString() { return "LiteralStub(" + this.value + ")"; }
    };
    ...
    this.CharClass.class = class CharClass {
      ...
      toString() { return "CharClass(" + this.start + ", " + this.end + ", " + this.inclusive + ")"; }
    };
    ...
    this.ClassLikeStub.class = class ClassLikeStub {
      ...
      toString() { return "ClassLikeStub(" + this.cons + ")"; }
    };
    ...
    this.Binder.class = class Binder {
      ...
      toString() { return "Binder(" + this.body + ")"; }
    };
    ...
    this.DebrujinBranch.class = class DebrujinBranch {
      ...
      toString() { return "DebrujinBranch(" + this.scrutinee + ", " + this.ptrn + ", " + this.consequent + ", " + this.alternative + ")"; }
    };
    ...
    this.Accept.class = class Accept {
      ...
      toString() { return "Accept(" + this.outcome + ")"; }
    };
    ...
    this.LitPattern.class = class LitPattern {
      ...
      toString() { return "LitPattern(" + this.lit + ")"; }
    };
    ...
    this.ClassLike.class = class ClassLike {
      ...
      toString() { return "ClassLike(" + this.sym + ", " + this.trm + ", " + this.parameters + ")"; }
    };
    ...
    this.Synonym.class = class Synonym {
      ...
      toString() { return "Synonym(" + this.symbol + ", " + this.patternArguments + ")"; }
    };
    ...
    this.Tuple.class = class Tuple {
      ...
      toString() { return "Tuple(" + this.size + ", " + this.inf + ")"; }
    };
    ...
    this.Record.class = class Record {
      ...
      toString() { return "Record(" + this.entities + ")"; }
    };
    ...
    this.Branch.class = class Branch {
      ...
      toString() { return "Branch(" + this.scrutinee + ", " + this.ptrn + ", " + this.continuation + ")"; }
    };
    ...
    this.Let.class = class Let {
      ...
      toString() { return "Let(" + this.sym + ", " + this.term + ", " + this.tail + ")"; }
    };
    ...
    this.Else.class = class Else {
      ...
      toString() { return "Else(" + this.default + ")"; }
    };
    this.End = class End {
      constructor() {}
      toString() { return "End"; }
    ...
    this.App.class = class App {
      ...
      toString() { return "App(" + this.lhs + ", " + this.rhs + ")"; }
    };
    ...
    this.Sel.class = class Sel {
      ...
      toString() { return "Sel(" + this.prefix + ", " + this.nme + ")"; }
    };
    ...
    this.DynSel.class = class DynSel {
      ...
      toString() { return "DynSel(" + this.prefix + ", " + this.fld + ", " + this.arrayIdx + ")"; }
    };
    ...
    this.Tup.class = class Tup {
      ...
      toString() { return "Tup(" + this.fields + ")"; }
    };
    ...
    this.IfLike.class = class IfLike {
      ...
      toString() { return "IfLike(" + this.kw + ", " + this.desugared + ")"; }
    };
    ...
    this.Lam.class = class Lam {
      ...
      toString() { return "Lam(" + this.params + ", " + this.body + ")"; }
    };
    ...
    this.Blk.class = class Blk {
      ...
      toString() { return "Blk(" + this.stats + ", " + this.res + ")"; }
    };
    ...
    this.New.class = class New {
      ...
      toString() { return "New(" + this.cls + ", " + this.args + ")"; }
    };
    ...
    this.Region.class = class Region {
      ...
      toString() { return "Region(" + this.name + ", " + this.body + ")"; }
    };
    ...
    this.RegRef.class = class RegRef {
      ...
      toString() { return "RegRef(" + this.reg + ", " + this.value + ")"; }
    };
    ...
    this.Assgn.class = class Assgn {
      ...
      toString() { return "Assgn(" + this.lhs + ", " + this.rhs + ")"; }
    };
    ...
    this.Deref.class = class Deref {
      ...
      toString() { return "Deref(" + this.ref + ")"; }
    };
    ...
    this.SetRef.class = class SetRef {
      ...
      toString() { return "SetRef(" + this.ref + ", " + this.value + ")"; }
    };
    ...
    this.Ret.class = class Ret {
      ...
      toString() { return "Ret(" + this.result + ")"; }
    };
    ...
    this.Throw.class = class Throw {
      ...
      toString() { return "Throw(" + this.result + ")"; }
    };
    ...
    this.Try.class = class Try {
      ...
      toString() { return "Try(" + this.body + ", " + this.finallyDo + ")"; }
    };
  }
  toString() { return "Term"; }
}; Term1 = new Term$class;
Term1.class = Term$class;
null
let Term = Term1; export default Term;
