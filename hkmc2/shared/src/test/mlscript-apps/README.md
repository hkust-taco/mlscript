...
This is the directory for apps.

## App Manifestation File

Each app's directory should contain a manifestation file `manifest.json`.
...
This option specifies which source code files from outside the app need to be vendored into the current app
...
Note that when compiling each app,
